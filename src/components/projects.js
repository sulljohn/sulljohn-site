  ...
  return (
    <div className="contentContainer">
      <div className="projects">
        ...
        <div data-aos="fade-in" className="projectFooter">For more information about any of these projects, please <a href="mailto:js@sulljohn.com?Subject=Project%20Inquiry" target="_top" className="projectInquiry">Contact Me</a>.</div>
